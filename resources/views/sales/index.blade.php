                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <div class="row">
                                                    <div class="col-12"><select name="select-prod_id" id="select-prod_id"
                                                            ...
                                                            @foreach ($products as $product)
                                                                <option value="{{ $product->id }}_{{ $product->price }}">
                                                                    {{ $product->name }}</option>
                                                            @endforeach
                                                        </select></div>
                                                </div>
                                        ...
                                        <div class="row" id="price_wholeSale">
                                            ...
                                            <div class="col-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="prod_priceRatail" name="prod_priceRatail"
                                                        required="required" class="form-control text-center"
                                                        placeholder="P. Venta" style="margin-left: 56px;" readonly>
                                                </div>
                                            </div>
                            ...
                            <div class="card" style="background: black;">
                                <div class="card-body">
                                    ...
                                    <input type="text"
                                        ...
                                        class="form-control text-center" id="total" name="total" value="S/. 0"
                                        readonly>
                                </div>
                            </div>
                            <div class="card">
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="num_venta" name="num_venta"
                                                    required="required" class="form-control text-center" value="0"
                                                    readonly>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="select-cust_dni" name="cust_dni" class="form-control"
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-2">
                                            ...
                                            <input class="form-control text-center" name="sale_efectivo"
                                                id="sale_efectivo" style="text-align: right;" placeholder="0" readonly>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-10">
                                            <div class="card" style="background: #ffcc0f;">
                                                <div class="card-body">
                                                    <div class="row">
                                                        <div class="col-8">
                                                            <h3 style="text-align: left; color:black; margin-top: 2.72px;">
                                                                <b>Vuelto:</b>
                                                            </h3>
                                                        </div>
                                                        <div class="col-4">
                                                            <input type="hidden" id="vuelto_save" name="vuelto_save">
                                                            <input type="text"
                                                                ...
                                                                name="vuelto" name="total" value="S/. 0" readonly>
